...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\Projects\\InternAssignment\\server\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "E:\\Projects\\InternAssignment\\server\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:Vinay@localhost:5432/InternAssignment"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id       Int    @id @default(autoincrement())\n  email    String @unique\n  password String\n}\n",
  "inlineSchemaHash": "031124ec0ec48445eeb06adaab850903ddf56b9c8662924315cdc4e7ceb4e496",
  "copyEngine": true
}
